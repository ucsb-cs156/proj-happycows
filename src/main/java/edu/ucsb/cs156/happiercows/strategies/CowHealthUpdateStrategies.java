 ...
 *
 * <p>For information on Java enum's, see the Oracle Java Tutorial on <a
 * href="https://docs.oracle.com/javase/tutorial/java/javaOO/enum.html">Enum Types</a>, which are
 * far more powerful in Java than enums in most other languages.
 */
@Getter
@AllArgsConstructor
public enum CowHealthUpdateStrategies implements CowHealthUpdateStrategy {
  Linear(
    ...
    public double calculateNewCowHealth(CommonsPlus commonsPlus, UserCommons uC, int totalCows) {
      return uC.getCowHealth()
          - (totalCows - commonsPlus.getEffectiveCapacity())
              * commonsPlus.getCommons().getDegradationRate();
    }
  },
  Constant(
      "Constant",
  ...
  public static final CowHealthUpdateStrategies DEFAULT_ABOVE_CAPACITY = Linear;
  public static final CowHealthUpdateStrategies DEFAULT_BELOW_CAPACITY = Constant;
}
