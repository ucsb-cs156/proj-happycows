...
public class MilkTheCowsJobInd implements JobContextConsumer {
  ...
  public void accept(JobContext ctx) throws Exception {
    ...
    if (commonMilkedOpt.isPresent()) {
      ...
      Iterable<UserCommons> allUserCommons =
          userCommonsRepository.findByCommonsId(commonMilked.getId());

      for (UserCommons userCommons : allUserCommons) {
        MilkTheCowsJob.milkCows(
            ctx, commonMilked, userCommons, profitRepository, userCommonsRepository);
      }
