...
public class CreateCommonsParams {
  ...
  @Builder.Default private Boolean showLeaderboard = false;
  @Builder.Default private Boolean showChat = true;
  @NumberFormat private int capacityPerUser;
  @NumberFormat private int carryingCapacity;
