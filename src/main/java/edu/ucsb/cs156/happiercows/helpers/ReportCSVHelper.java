...
public class ReportCSVHelper {
  ...
  /**
   * This method is a hack to avoid a jacoco issue; it isn't possible to exclude an individual
   * method call from jacoco coverage, but we can exclude the entire method.
   *
   * @param out
   */
