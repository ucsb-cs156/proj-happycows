...
public class CommonsControllerTests extends ControllerTestCase {
  ...
  @MockBean CommonsPlusBuilderService commonsPlusBuilderService;
  ...
  public void getDefaultCommonsValuesTest() throws Exception {
    Map<String, Object> expectedDefaults =
        Map.of(
            "id",
            0,
            "name",
    ...
    Map<String, Object> actualDefaults =
    ...
    assertEquals(
        expectedDefaults.get("aboveCapacityHealthUpdateStrategy"),
        actualDefaults.get("aboveCapacityHealthUpdateStrategy"));
    assertEquals(
        expectedDefaults.get("belowCapacityHealthUpdateStrategy"),
  ...
  public void createCommonsTest() throws Exception {
    ...
    CreateCommonsParams parameters =
        CreateCommonsParams.builder()
            .name("Jackson's Commons")
            .cowPrice(500.99)
            .milkPrice(8.99)
            .startingBalance(1020.10)
    ...
    when(commonsRepository.save(commons)).thenReturn(commons);
  ...
  public void getCommonsTest() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/commons/all").contentType("application/json"))
            .andExpect(status().isOk())
            .andReturn();
    ...
    List<Commons> actualCommons =
        objectMapper.readValue(responseString, new TypeReference<List<Commons>>() {});
  ...
  public void updateCommonsTest() throws Exception {
    ...
    when(commonsRepository.findById(0L)).thenReturn(Optional.of(commons));
  ...
  public void updateCommonsTest_withNoCowHealthUpdateStrategy() throws Exception {
    ...
    assertEquals(
        CowHealthUpdateStrategies.Constant, commons.getAboveCapacityHealthUpdateStrategy());
  ...
  public void getCommonsByIdTest_valid() throws Exception {
    Commons Commons1 = Commons.builder().name("TestCommons2").id(18L).build();

    when(commonsRepository.findById(eq(18L))).thenReturn(Optional.of(Commons1));

    MvcResult response =
        mockMvc.perform(get("/api/commons?id=18")).andExpect(status().isOk()).andReturn();
  ...
  public void getCommonsPlusByIdTest_valid() throws Exception {
    ...
    CommonsPlus commonsPlus =
        CommonsPlus.builder().commons(commons1).totalCows(5).totalUsers(2).build();
    ...
    MvcResult response =
        mockMvc.perform(get("/api/commons/plus?id=18")).andExpect(status().isOk()).andReturn();
  ...
  public void getCommonsByIdTest_invalid() throws Exception {
    ...
    MvcResult response =
        mockMvc.perform(get("/api/commons?id=18")).andExpect(status().is(404)).andReturn();
  ...
  public void getCommonsPlusByIdTest_invalid() throws Exception {
    ...
    MvcResult response =
        mockMvc.perform(get("/api/commons/plus?id=18")).andExpect(status().is(404)).andReturn();
  ...
  public void getHealthUpdateStrategiesTest() throws Exception {
    var response =
        mockMvc
            .perform(get("/api/commons/all-health-update-strategies"))
            .andExpect(status().isOk())
            .andReturn();
    ...
    var actual =
        mapper.readValue(
            response.getResponse().getContentAsString(), HealthUpdateStrategyList.class);
  ...
  public void joinCommonsTest() throws Exception {
    ...
    when(userCommonsRepository.findByCommonsIdAndUserId(anyLong(), anyLong()))
  ...
  public void already_joined_common_test() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/commons/join?commonsId=2")
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .characterEncoding("utf-8")
                    .content(requestBody))
  ...
  public void deleteCommons_test_admin_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(delete("/api/commons?id=2").with(csrf()))
  ...
  public void deleteCommons_test_admin_nonexists() throws Exception {
    ...
    String expectedString =
        "{\"message\":\"Commons with id 2 not found\",\"type\":\"EntityNotFoundException\"}";

    Map<String, Object> expectedJson =
        mapper.readValue(expectedString, new TypeReference<Map<String, Object>>() {});
  ...
  public void deleteUserFromCommonsTest() throws Exception {
    ...
    String responseString = response.getResponse().getContentAsString();
    String expectedString =
        "{\"message\":\"user with id 1 deleted from commons with id 2, 0 users remain\"}";
  ...
  public void getCommonsPlusTest() throws Exception {
    ...
    CommonsPlus CommonsPlus1 =
        CommonsPlus.builder().commons(Commons1).totalCows(50).totalUsers(20).build();
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/commons/allplus").contentType("application/json"))
            .andExpect(status().isOk())
            .andReturn();
    ...
    String responseString = response.getResponse().getContentAsString();
    List<CommonsPlus> actualCommonsPlus =
        objectMapper.readValue(responseString, new TypeReference<List<CommonsPlus>>() {});
  ...
  void test_capacity_with_lower_per_user() throws Exception {
    ...
    CommonsPlus commonsPlus =
        CommonsPlus.builder().commons(commons).totalUsers(1).totalCows(5).build();
  ...
  void test_capacity_with_higher_per_user() throws Exception {
    ...
    CommonsPlus commonsPlus =
        CommonsPlus.builder().commons(commons).totalUsers(2).totalCows(5).build();
