...
public class AnnouncementsControllerTests extends ControllerTestCase {
  ...
  public void adminCanPostAnnouncements() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post(
                        "/api/announcements/post?commonsId={commonsId}&startDate={start}&endDate={end}&announcementText={announcement}",
                        commonsId,
                        start,
                        end,
                        announcement)
  ...
  public void userInCommonsCanPostAnnouncements() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post(
                        "/api/announcements/post?commonsId={commonsId}&startDate={start}&announcementText={announcement}",
                        commonsId,
                        start,
                        announcement)
                    .with(csrf()))
  ...
  public void userCanPostAnnouncementWithoutStartAndEndTime() throws Exception {
    ...
    Announcement announcementObj =
        Announcement.builder().id(id).commonsId(commonsId).announcementText(announcement).build();
  ...
  public void adminCannotDeleteAnnouncementsThatDontExist() throws Exception {
    ...
    // act
    mockMvc
        .perform(delete("/api/announcements/delete?id={id}", id).with(csrf()))
        .andExpect(status().isBadRequest())
        .andReturn();
  ...
  public void userCanGetAllAnnouncements() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/announcements/getbycommonsid?commonsId={commonsId}", commonsId))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void userCanGetAnnouncementById() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/announcements/getbyid?id={id}", id))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void adminCanEditAnnouncement() throws Exception {
    ...
    Announcement editedAnnouncementObj =
        Announcement.builder()
            .id(id)
            .commonsId(commonsId)
    ...
    MvcResult editedResponse =
        mockMvc
            .perform(
                put(
                        "/api/announcements/put?id={id}&commonsId={commonsId}&startDate={start}&endDate={end}&announcementText={announcement}",
                        id,
                        commonsId,
                        editedStart,
                        editedEnd,
  ...
  public void userCannotEditAnnouncementIfNotInCommons() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                put(
                        "/api/announcements/put?id={id}&commonsId={commonsId}&startDate={start}&announcementText={announcement}",
                        id,
                        commonsId,
                        start,
                        announcement)
