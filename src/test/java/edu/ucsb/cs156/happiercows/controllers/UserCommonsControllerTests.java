...
public class UserCommonsControllerTests extends ControllerTestCase {
  ...
  public void test_getUserCommonsById_exists_admin() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/usercommons?userId=1&commonsId=1"))
  ...
  public void test_getUserCommonsById_nonexists_admin() throws Exception {
    ...
    String expectedString =
        "{\"message\":\"UserCommons with commonsId 1 and userId 1 not found\",\"type\":\"EntityNotFoundException\"}";
  ...
  public void test_getUserCommonsById_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/usercommons/forcurrentuser?commonsId=1"))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_BuyCow_commons_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/buy?commonsId=1&numCows=2").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_BuyCow_commons_exists_user_has_exact_amount_needed() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/buy?commonsId=1&numCows=1").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_SellCow_commons_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/sell?commonsId=1&numCows=2").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_buyCow_for_user_not_in_commons() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/buy?commonsId=234&numCows=2").with(csrf()))
            .andExpect(status().is(404))
            .andReturn();
    ...
    String expectedString =
        "{\"message\":\"UserCommons with commonsId 234 and userId 1 not found\",\"type\":\"EntityNotFoundException\"}";
    Map<String, Object> expectedJson = mapper.readValue(expectedString, Map.class);
    Map<String, Object> jsonResponse = responseToJson(response);
    assertEquals(expectedJson, jsonResponse);
  }
  ...
  public void test_sellCow_for_user_not_in_commons() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/sell?commonsId=234&numCows=2").with(csrf()))
            .andExpect(status().is(404))
            .andReturn();
  ...
  public void test_buyCow_commons_does_not_exist() throws Exception {
    ...
    when(userCommonsRepository.findByCommonsIdAndUserId(eq(1L), eq(1L)))
        .thenReturn(Optional.of(getTestUserCommons()));

    // act
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/buy?commonsId=234&numCows=3").with(csrf()))
            .andExpect(status().is(404))
            .andReturn();

    // assert
    String expectedString =
        "{\"message\":\"Commons with id 234 not found\",\"type\":\"EntityNotFoundException\"}";
    Map<String, Object> expectedJson = mapper.readValue(expectedString, Map.class);
    Map<String, Object> jsonResponse = responseToJson(response);
    assertEquals(expectedJson, jsonResponse);
  }
  ...
  public void test_sellCow_commons_does_not_exist() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/sell?commonsId=234&numCows=3").with(csrf()))
            .andExpect(status().is(404))
            .andReturn();
  ...
  public void test_BuyCow_commons_exists_not_enough_money() throws Exception {
    ...
    // assert
    String expectedString =
        "{\"message\":\"You need more money!\",\"type\":\"NotEnoughMoneyException\"}";
    Map<String, Object> expectedJson = mapper.readValue(expectedString, Map.class);
    Map<String, Object> jsonResponse = responseToJson(response);
    assertEquals(expectedJson, jsonResponse);
  }
  ...
  public void test_SellCow_commons_exists_no_cow_to_sell() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/sell?commonsId=1&numCows=1").with(csrf()))
            .andExpect(status().is(400))
            .andReturn();

    // assert
    String expectedString =
        "{\"message\":\"You do not have enough cows to sell!\",\"type\":\"NoCowsException\"}";
    Map<String, Object> expectedJson = mapper.readValue(expectedString, Map.class);
    Map<String, Object> jsonResponse = responseToJson(response);
    assertEquals(expectedJson, jsonResponse);
  }
  ...
  public void test_BuyCow_not_enough_money() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(put("/api/usercommons/buy?commonsId=1&numCows=3").with(csrf()))
            .andExpect(status().is(400))
            .andReturn();
  ...
  public void test_getAllUserCommonsById_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/usercommons/commons/all?commonsId=1"))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_Admin_getAllUserCommonsById_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/usercommons/commons/all?commonsId=1").with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
