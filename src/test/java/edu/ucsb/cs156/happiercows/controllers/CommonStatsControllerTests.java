...
public class CommonStatsControllerTests extends ControllerTestCase {
  ...
  CommonStats expectedStats2 =
      CommonStats.builder().commonsId(42L).numCows(120).avgHealth(20).build();
  ...
  public void get_all_common_stats() throws Exception {
    ...
    List<CommonStats> actualStats =
        objectMapper.readValue(responseString, new TypeReference<List<CommonStats>>() {});
  ...
  public void get_stats_by_commonsId() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/commonstats/commons?commonsId=17"))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void test_get_csv() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/commonstats/download?commonsId=17"))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();
    ...
    String expected = "id,commonsId,numCows,avgHealth,createDate\r\n" + "0,17,20,10.0,null\r\n";
  ...
  public void test_get_all_csv() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/commonstats/downloadAll"))
            .andDo(print())
            .andExpect(status().isOk())
            .andReturn();
