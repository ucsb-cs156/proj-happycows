...
public class UpdateCowHealthJobIndTests extends JobTestCase {
  ...
  @Mock UpdateCowHealthJob updateCowHealthJob;
  ...
  private final CommonsPlus commonsPlus =
      CommonsPlus.builder().commons(commons).totalCows(1).totalUsers(1).build();
