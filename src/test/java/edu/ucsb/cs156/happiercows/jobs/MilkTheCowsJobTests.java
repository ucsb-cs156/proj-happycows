...
public class MilkTheCowsJobTests extends JobTestCase {
  ...
  void test_log_output_no_commons() throws Exception {
    ...
    // Act
    MilkTheCowsJob milkTheCowsJob =
        new MilkTheCowsJob(
            commonsRepository, userCommonsRepository, userRepository, profitRepository);
  ...
  void test_log_output_with_commons_and_user_commons() throws Exception {
    ...
    when(commonsRepository.getNumCows(testCommons.getId()))
  ...
  void test_milk_cows() throws Exception {
    ...
    UserCommons updatedUserCommons =
        UserCommons.builder()
            .user(user)
            .commons(testCommons)
            .totalWealth(300.20)
    ...
    MilkTheCowsJob.milkCows(
        ctx, testCommons, origUserCommons, profitRepository, userCommonsRepository);
