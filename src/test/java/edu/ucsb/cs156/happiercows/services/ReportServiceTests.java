...
class ReportServiceTests {
  ...
  void test_createAndSaveReportHeader() {
    ...
    when(commonsRepository.getNumUsers(commons.getId()))
        .thenReturn(Optional.of(Integer.valueOf(1)));
    when(commonsRepository.getNumCows(commons.getId()))
        .thenReturn(Optional.of(Integer.valueOf(123)));
  ...
  void test_createAndSaveReportHeader_throwsException() {
    ...
    Assertions.assertTrue(
        ...
        String.format(
            "Expected message to contain \"%s\" but was \"%s\"", expectedMessage, message));
  }
