...
describe("LeaderboardTable tests", () => {
  ...
  test("Total wealth is formatted correctly", () => {
    ...
    expect(screen.getAllByText("93.50")[0]).toHaveStyle("text-align: right;");
  ...
  test("Users are sorted correctly by total wealth", () => {
    ...
    const wealthHeader = screen.getByTestId(
      "LeaderboardTable-header-totalWealth",
    );
