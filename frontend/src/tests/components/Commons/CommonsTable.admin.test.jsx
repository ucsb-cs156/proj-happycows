...
describe('CommonsTable admin actions', () => {
  ...
  test('renders admin action buttons and modal open/close', async () => {
    ...
    expect(screen.getByTestId('CommonsTable-card-0-action-Edit')).toBeInTheDocument();
    expect(screen.getByTestId('CommonsTable-card-0-action-Delete')).toBeInTheDocument();
    expect(screen.getByTestId('CommonsTable-card-0-action-Leaderboard')).toBeInTheDocument();
    expect(screen.getByTestId('CommonsTable-card-0-action-StatsCSV')).toBeInTheDocument();
    expect(screen.getByTestId('CommonsTable-card-0-action-Announcements')).toBeInTheDocument();

    // open delete modal
    await userEvent.click(screen.getByTestId('CommonsTable-card-0-action-Delete'));
