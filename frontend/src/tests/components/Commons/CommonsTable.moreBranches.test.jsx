...
describe('CommonsTable additional sorting branches', () => {
  ...
  test('effectiveCapacity uses explicit vs computed values', async () => {
    ...
    const commons = [
      { commons: { id: 1, name: 'Exp', milkPrice: '1', capacityPerUser: null }, totalCows: '2', effectiveCapacity: 50 },
      { commons: { id: 2, name: 'Comp', milkPrice: '2', capacityPerUser: 10 }, totalCows: '3', commonsPlusExtra: true },
    ...
    const commonsPlus = [
      { commons: commons[0].commons, totalCows: commons[0].totalCows, effectiveCapacity: 50 },
      { commons: { ...commons[1].commons }, totalUsers: 3, totalCows: commons[1].totalCows },
