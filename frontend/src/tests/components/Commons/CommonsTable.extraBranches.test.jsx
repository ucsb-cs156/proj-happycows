...
import CommonsTable, { getSortableValue } from 'main/components/Commons/CommonsTable'
...
describe('CommonsTable extra branches', () => {
  ...
  test('confirm delete calls mutate with correct params', async () => {
    mutateSpy.mockClear()
    const commons = [{ commons: { id: 42, name: 'ToDelete' }, totalCows: 0, effectiveCapacity: 0 }]
