...
describe("OurTable tests", () => {
    ...
    test("renders a table with 51 rows and tests the first page", async () => {
        render(
            <OurTable columns={columns} data={fiftyOneRows} />
        );
        expect(await screen.findByTestId("testid-next-page-button")).toBeInTheDocument();
        expect(await screen.queryByTestId("testid-left-ellipses")).toBe(null);
        expect(await screen.queryByTestId("testid-back-three-page-button")).toBe(null);
        expect(await screen.queryByTestId("testid-back-two-page-button")).toBe(null);
        expect(await screen.queryByTestId("testid-back-one-page-button")).toBe(null);
        expect(await screen.findByTestId("testid-current-page-button")).toContainHTML("1");
        ...
        expect(await screen.queryByTestId("testid-forward-three-page-button")).toBe(null);
    ...
    test("renders a table with 51 rows and tests moving forward and back one page", async () => {
        ...
        expect(await screen.findByTestId("testid-forward-one-page-button")).toBeInTheDocument();
        expect(await screen.findByTestId("testid-back-one-page-button")).toContainHTML("1");
    ...
    test("renders a table with 51 rows and moving forward and back two pages", async () => {
        ...
        fireEvent.click(lastButton);
        expect(await screen.findByTestId("testid-current-page-button")).toContainHTML("6");
        expect(await screen.queryByTestId("testid-forward-two-page-button")).toBe(null);
        expect(await screen.findByTestId("testid-back-one-page-button")).toContainHTML("5");
        const backOneButton = screen.getByTestId("testid-back-one-page-button");
        fireEvent.click(backOneButton);
        ...
        expect(await screen.findByTestId("testid-forward-two-page-button")).toContainHTML("6");
        ...
        expect(await screen.findByTestId("testid-back-two-page-button")).toContainHTML("1");
    });

    test("renders a table with 41 rows and moving forward and back three pages", async () => {
        render(
            <OurTable columns={columns} data={fortyOneRows} />
        );
