...
describe("AdminEditGamePage tests", () => {
  describe("tests where backend is working normally", () => {
    ...
    beforeEach(() => {
      ...
      axiosMock.onGet("/api/game", { params: { id: 5 } }).reply(200, {
        id: 5,
        name: "Seths Common",
      ...
      axiosMock.onPut("/api/game/update").reply(200, {
        id: 5,
        name: "Phill's Game",
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(nameField, { target: { value: "Phill's Game" } });
      ...
      expect(mockToast).toBeCalledWith(
        "Game Updated - id: 5 name: Phill's Game",
      );
      expect(mockNavigate).toBeCalledWith({
        to: "/admin/listgamev2?focus=5",
      });
