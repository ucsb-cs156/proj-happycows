...
describe("AdminCreateGamePage tests", () => {
  ...
  test("When you fill in form and click submit, the right things happens", async () => {
    axiosMock.onPost("/api/game/new").reply(200, {
      id: 5,
      name: "My New Game",
      cowPrice: 10,
      milkPrice: 5,
    ...
    const gameNameField = screen.getByLabelText("Game Name");
    ...
    const button = screen.getByTestId("GameForm-Submit-Button");

    fireEvent.change(gameNameField, { target: { value: "My New Game" } });
