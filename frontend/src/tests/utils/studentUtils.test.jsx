...
describe("studentUtils tests", () => {
  describe("onDeleteSuccess", () => {
    test("logs message and shows toast", () => {
      const restoreConsole = mockConsole();

      onDeleteSuccess("Student deleted!");

      expect(mockToast).toHaveBeenCalledWith("Student deleted!");
      expect(console.log).toHaveBeenCalled();
      expect(console.log.mock.calls[0][0]).toMatch("Student deleted!");
